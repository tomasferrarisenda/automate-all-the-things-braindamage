...
Cambios para traces: instalar jaeger, instrumentar backend

In the Jaeger UI under the services you'll find the traces generated by our instrumented code but also the ones generated by istio. Our code is instrumented automatically so you wont find many differences between the code traces and the istio traces. You could manually instrument the code if you want to get more detailed information, like how long it took to run a specific function.
